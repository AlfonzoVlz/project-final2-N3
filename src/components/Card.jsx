...
export const Card = ({ fetchRepos, repos }) => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 gap-5 justify-center '>
      {repos.slice(0, 4).map(repo => (
        <a
          ...
          className='h-auto w-auto  mt-3 gap-5 text-[#CDD5E0] bg-gradient-to-r from-[#111729] to-[#1D1B48] rounded-2xl p-3'
        >
          <div>
            <span className='text-2xl md:text-3xl'>{repo.name}</span>
            <p className='text-lg md:text-xl mt-2'>{repo.description}</p>
