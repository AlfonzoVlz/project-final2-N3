...
<div className='flex justify-evenly w-full h-40  text-[#CDD5E0] '>
        <div className='w- flex flex-col'>
          <figure className='w-32 h-32 absolute top-[33%]'>
            <img src={gitHub} alt="GitHub" className='rounded-lg border-solid border-[10px] border-[#20293A] ' />
          </figure>
        ...
        <div className='mt-5 bg-[#111729] px-4 py-2 rounded-lg h-14 w-[350px] flez items-center text-2xl'>
          <span className='mr-5 font-normal text-[#4a5366] '>Location</span>
          <span className='ml-5'>San Francisco, CA</span>
        </div>
      </div>
</>
  )
