...
export const Card = () => {
  return (
<>
<div className='h-40 w-full flex justify-center items-center mt-3 gap-20 text-[#CDD5E0]'>
        <div className='h-32 w-[700px] bg-gradient-to-r from-[#111729] to-[#1D1B48] rounded-2xl p-3 gap-2 '>
          <span className=' text-3xl'>.github</span>
          <p className='text-xl mt-2'>Community health files for the @GitHub organization</p>
          <div className='flex items-center gap-3 mt-2'>
            ...
            <span>703</span>
            <span className='ml-4'>Updated 4 days ago</span>
          </div>

        </div>

        <div className='h-40 w-[700px] bg-gradient-to-r from-[#111729] to-[#1D1B48] rounded-2xl p-3 gap-2 '>
          <span className=' text-3xl'>accessibility-alt-text-bat</span>
          <p className='text-xl mt-2'>An action to remind users to add alt text on Issues, Pull <br />
            Requests, and Discussions
          </p>
          <div className='flex items-center gap-3 mt-2'>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.8 16.4L15 17.75C13.2222 19.0833 10.7778 19.0833 9 17.75L7.2 16.4C5.18555 14.8892 4 12.5181 4 10V6C4 4.89543 4.89543 4 6 4H18C19.1046 4 20 4.89543 20 6V10C20 12.5181 18.8144 14.8892 16.8 16.4Z" stroke="#97A3B6" />
            ...
            <span>50</span>
            <span className='ml-4'>Updated 3 days ago</span>
          </div>

        </div>
      </div>

      <div className='h-40 w-full flex justify-center items-center gap-20 text-[#CDD5E0] '>
        <div className='h-32 w-[700px] bg-gradient-to-r from-[#111729] to-[#1D1B48] rounded-2xl p-3 gap-2 '>
          <span className=' text-3xl'>accessibilityjs</span>
          <p className='text-xl mt-2'>Client side accessibility error scanner</p>
          <div className='flex items-center gap-3 mt-2'>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.8 16.4L15 17.75C13.2222 19.0833 10.7778 19.0833 9 17.75L7.2 16.4C5.18555 14.8892 4 12.5181 4 10V6C4 4.89543 4.89543 4 6 4H18C19.1046 4 20 4.89543 20 6V10C20 12.5181 18.8144 14.8892 16.8 16.4Z" stroke="#97A3B6"  />
              <circle cx="12" cy="10" r="1" fill="#97A3B6" />
        ...
        <div className='h-32 w-[700px] bg-gradient-to-r from-[#111729] to-[#1D1B48] rounded-2xl p-3 gap-2 '>
          <span className=' text-3xl'>actions-chat-sheet</span>
          <p className='text-xl mt-2'>A cheat sheet for GitHub Actions</p>
          <div className='flex items-center gap-3 mt-2'>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M16.8 16.4L15 17.75C13.2222 19.0833 10.7778 19.0833 9 17.75L7.2 16.4C5.18555 14.8892 4 12.5181 4 10V6C4 4.89543 4.89543 4 6 4H18C19.1046 4 20 4.89543 20 6V10C20 12.5181 18.8144 14.8892 16.8 16.4Z" stroke="#97A3B6" />
              <circle cx="12" cy="10" r="1" fill="#97A3B6" />
